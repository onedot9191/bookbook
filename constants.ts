...
export const SECTIONS: SectionData[] = [
  ...
  },
  {
    ...
    title: '5. 정책 설계 원리',
    content: [
      "[주도성]: 사회 구성원으로서 가치와 규범을 [내면화]하고 자신의 삶을 조직하여 [적극적]으로 이끌어 가는 것으로 정의할 수 있다. 학생들은 두려움 없이 자신을 표현하고 학습 활동에 [자발적]으로 참여하는 경험을 통해 자신감을 얻게 되고, 이는 또 다른 동기부여와 성취감으로 발전하여 추진력과 방향성을 갖게 된다.",
      "[관계성]: 두 사람 이상의 사이에서 심리·정서·신체적으로 [연결]되거나 관련되는 것으로 정의할 수 있다. 학생들은 교사와 친구 뿐만 아니라 이웃들과의 상호작용을 통해 ‘나’를 둘러싼 대상과 긍정적인 [관계]를 만들어가며, ‘나’의 존재를 [성찰]하는 과정을 통해 성장한다.",
      "[자율성]: [자기결정]에 따라 스스로 생각하고 행동하는 것으로 정의할 수 있으며, [책임]을 전제로 한다. 학생들은 학교 및 일상적인 삶 속에서 합리적인 선택과 결과에 대한 경험을 축적하는 과정을 통해 자기결정에 대한 확고한 신념과 끝까지 수행하려는 의지를 갖게 된다."
    ]
  },
  {
    id: 'goals',
