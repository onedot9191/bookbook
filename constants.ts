        ...
        children: [
          ...
          },
          {
            ...
            children: [
              { title: '[1학생 1예술활동]' },
              { title: '[대구학생예술창작터]' },
              { title: '문화소외지역: [예술숲학교], [예술드림 거점학교] 운영' },
              { title: '평생친구 [1인 1악기 성취목표인증제]' }
            ]
          }
        ]
      },
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    children: [
                      { title: '한국어 예비과정: [한국어교육]센터, 달성 한국어교육(예비과정) 거점학교신설' },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            title: '도서관 활용 서비스',
            children: [
              { title: '[지역사회] [개방형] [거점 학교도서관] 운영 ex. 대구 테크노초' }
            ]
          },
          {
            title: '학교시설 융·복합화',
