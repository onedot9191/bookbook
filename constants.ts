            ...
            children: [
                ...
                children: [
                  {
                    ...
                    children: [
                      { title: '기초학력 진단검사 (초2~고2)' },
                      { title: '책임교육학년 학력 진단 강화 및 체계적 학습 (초3, 중1)' },
                      { title: '컴퓨터기반 맞춤형 학업성취도 자율평가 (초3~고2)' },
                      { title: '학기말 성취수준 진단검사 및 개별학력 분석 프로그램(초)' },
                      { title: '학업문제 및 학생 특성 파악 표준화검사(초)' },
              ...
              },
              {
                ...
                children: [
                  ...
                  { title: '문해력 돋움학교, 문해력 교사연구회 운영(초)' },
                  { title: '초기 문해력 지도 전문가 양성(초)' },
                  { title: '기초 및 교과 문해력, 수리력 지도 역량 강화 연수' }
                ]
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    children: [
                      { title: '난독 진단검사' },
                      { title: '난독바우처 서비스 및 난독학생 지원단' }
                    ]
                  },
                  {
                    title: '경계선지능학생 맞춤형 교육 지원',
                    children: [
                      { title: '경계선지능학생 전문진단검사' },
                      { title: '학습코칭 및 학습바우처' }
                    ]
                  }
                ]
            ...
            children: [
              {
                title: '운영 기반 구축',
                children: [
                  { title: '창의융합메이커실 여건 개선 및 운영 지원' },
                  { title: '메이커 관련 기자재 안전시설 지원' },
                  { title: '권역별 네트워크 및 지원체계 구축' },
                  {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    children: [
                      ...
                      { title: '대구창의융합교육축전(수학·과학·SW·메이커·환경·직업교육 등)' }
                    ]
                  }
                ]
              }
            ...
            children: [
              {
                ...
                children: [
                  ...
                  { title: '학년군 공동 탐구프로젝트 운영 교사 역량 강화' },
                  { title: '학년군 공동 탐구프로젝트 운영학교 지원' }
                ]
              },
              {
                title: '학교자율시간',
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    children: [
                      ...
                      { title: '교과 학년 협의회 연계 중등 수업-평가 공동체' }
                    ]
                  },
                  {
              ...
              },
              {
                ...
                children: [
                  ...
                  { title: '교실수업개선 연구학교 운영(초·중)' },
                  { title: '질문하는 학교 선도학교 운영(초·중)' },
                  {
                    title: '대구 글로벌 원격협력학습 운영 지원(초)',
                    children: [
                      { title: 'Web 기반 협력수업(호주, 뉴질랜드, 대만 등)' },
                      { title: '국가 간 교사 및 학생 협력을 통한 공동 탐구학습 운영' }
                    ]
                  },
                  {
            ...
            children: [
              {
                ...
                children: [
                  ...
                  {
                    title: '진로진학지원센터 운영(시교육청1, 교육지원청5)',
                    children: [
