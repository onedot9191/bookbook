...
export const INTERVIEW_SECTIONS: SectionData[] = [
  {
    ...
    content: [
      ...
      "",
      "결론: 이번 일은 [당장의 문제 해결]을 넘어 [교육현장]을 발전시키는 [디딤돌]이 될 것입니다. [비 온 뒤에 땅이 굳어지듯], [더욱 단단하고 성숙한 교육 현장]을 만드는 교사가 되겠습니다.",
      "",
      "2. 즉답형",
      "",
      "서론: (주제)는 [교사]가 [외면하지 않고] 반드시 [해결해야 할] [현실적인 문제]입니다.",
      "",
      "결론: 이러한 [위기]를 [긍정적인 변화]의 [기회]로 삼는 [현명한 교사]가 되겠습니다."
    ]
  },
  {
    id: 'value',
    ...
    content: [
      ...
      "",
      "결론: [형식적인 운영]에 그치지 않고, [미래를 배우고 함께 성장하는 대구교육]에 기여하는 교사가 되겠습니다.",
      "",
      "2. 즉답형",
      "",
      "서론: (주제)는 우리 [학생들의 역량]을 키워주기 위한 [필수적인 자양분]입니다.",
      "",
      "결론: (주제)를 통해 [학생들의 역량]을 꽃피우는 [든든한 교사]가 되겠습니다."
    ]
  },
  {
    id: 'data',
    ...
    content: [
      "1. 구상형",
      "",
      "서론: 제시된 (주제) 자료는 [교육의 현주소]를 보여주는 [의미 있는 메시지]를 담고 있습니다. [올바른 해석]을 위해서는 [현상]에 대한 [정확한 이해]가 [선행]되어야 합니다.",
      "",
      "결론: [깊이 있는 이해]가 [발전의 시작]입니다. [보여주기식]이 아닌, [교육 현장]에 닿는 [실질적인 개선]을 이끌어내는 교사가 되겠습니다.",
      "",
      "2. 즉답형",
      "",
      "서론: (주제) 자료는 [교육의 방향]을 가리키는 [중요한 신호]입니다.",
      "",
      "결론: [근본적인 해결책]을 통해 [실질적인 개선]을 [실천하는 교사]가 되겠습니다."
    ]
  }
];
