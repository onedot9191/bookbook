            ...
            children: [
              {
                title: '교우관계 존중교육',
                children: [
                  { title: '교육과정 연계 어울림 프로그램 및 공감프로젝트 확대 실시' },
                  { title: '전 학교 전문상담인력 지원' },
                  {
                    title: '위(Wee) 프로젝트 운영(위(Wee)클래스-위(Wee)센터-위(Wee)스쿨)',
                    children: [
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  ...
                  { title: '청소년 디지털 미디어 이용습관 진단조사(초6, 중2, 고2) 및 상담 지원' },
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  ...
                  { title: '꿈키움멘토단 운영' },
                  { title: '현장형 Wee Cafe「친구랑」, 가정형 위(Wee) 센터 운영' }
                ]
              },
              {
                title: '문해교육',
                children: [
                  { title: '‘대구내일학교’ 운영' },
                  { title: '학력인정 문해교육 프로그램 설치ㆍ지정 및 운영 지원' },
                  { title: '기초 문해교육 프로그램 운영 지원' }
                ]
              }
            ]
          },
                ...
                children: [
                  {
                    title: '대구민주시민교육센터 운영',
                    children: [
                      { title: '체험중심 및 지역 연계 민주시민교육 프로그램' }
                    ]
                  },
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                title: '교육국제화 특구',
                children: [
                  { title: '학습자 맞춤형 외국어교육 및 세계시민교육 프로그램 운영' },
                  { title: '교육국제화특구 현장지원 교육연구회 운영' },
                  { title: '교육국제화 및 외국어 교육활동 성과 공유 페스티벌 운영' }
                ]
              }
            ]
          }
            ...
            children: [
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    children: [
                      { title: '[학생언어문화개선], [또래 상담] 등 [학생 주도] 학교폭력예방활동' },
