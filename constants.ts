                ...
                children: [
                  {
                    title: '목표: [기초학력] 보장',
                    children: [
                      { title: '[학습 결손]을 조기에 발견하고 개인별 특성에 맞춘 지원을 통해 [학력 격차]를 최소화한다.' }
                    ]
                  },
                  {
                    title: '0단계: 선정',
                    children: [
                      { title: '[기초학력 진단검사] 및 [맞춤형 학업성취도 자율평가] 등을 통해 [학습지원대상학생]을 선정' }
                    ]
                  },
                  {
                  ...
                  {
                    title: '2단계: [학교 안] [맞춤형] 지원',
                    children: [
                      { title: '[두드림학교]를 운영하여 돌봄, 정서·행동, 이주 배경 등 [복합적] 요인으로 어려움을 겪는 학생을 다각도로 도움' }
                    ]
                  },
                  {
                    title: '3단계: [학교 밖] [전문적] 지원',
                    children: [
                      { title: '[기초학력지원센터]와 연계하여 경계선 지능이나 난독 등 [특수] 요인이 있는 학생에게 [학습클리닉]을 제공' }
                    ]
                  }
                ]
              },
        ...
        children: [
          {
            title: '서론',
            children: [
              { title: '그동안 대구교육은 교육의 본질에 집중하며, [학생이 주도하는 배움]으로 공교육 혁신의 길을 흔들림 없이 걸어왔습니다.' }
            ]
          },
          {
            title: '대구시교육청 업적',
            children: [
              { title: '1) 교육부 [시도교육청 평가] 3년 연속 최우수' },
              { title: '2) 전국 최저 수준의 [기초학력 미달률]' },
              { title: '3) 전국 최저 수준의 [학교폭력 피해 응답률]' }
            ]
          },
          {
            title: '대구가 전국 최초로 시작한 정책들',
            children: [
              { title: '① [IB 프로그램]' },
              { title: '② [대구미래학교]' },
              { title: '③ [마음교육]' },
          ...
          },
          {
            title: '2026년 비전',
            children: [
              { title: '2026년: \'[대한민국 교육수도]\' -> \'[글로벌 교육수도]\'' },
              { title: '[지역]을 넘어 [인류의 보편가치]를 실천하는 [세계시민]을 기르고, [지역]과 [세계]가 [연결된 배움]이 이루어지는 학습생태계를 만들어 가겠습니다.' }
            ]
          },
          {
            title: '첫째, \'[세계적 배움]\'을 대구에서 실현하겠습니다',
            children: [
              { title: '대구교육은 수업과 평가 혁신을 통한 \'[깊이 있는 배움]\'으로 교실을 넘어 지역과 세계로 배움을 확장해 나가겠습니다.' },
              { title: '따뜻한 인간다움을 통한 [인성]과 [마음] 교육으로 \'[나를 넘어 우리]\'로, 더불어 인공지능 AI와 함께 살아가는 역량 강화에도 힘쓰겠습니다.' },
              { title: '대구의 아이들은 스스로 생각하고 탐구하며 삶을 개척하는 [평생 학습자]로 성장할 것입니다.' }
            ]
          },
          {
            title: '둘째, \'[세계적 가르침]\'을 대구에서 실천하겠습니다',
            children: [
              { title: 'AI 시대에 선생님은 [지식 전달자]가 아니라 학생의 삶과 성장을 돕는 \'[러닝 디자이너]\'이자 \'[학습 촉진자]\'입니다.' },
              { title: '더 따뜻하고, 더 깊게, 더 전문적으로 학생의 성장을 돕는 [상담]·[코칭] 중심의 \'[휴먼터치]\'를 강화하겠습니다.' },
              { title: '교육활동이 존중받도록 학교 지원체계를 더 촘촘히 하겠습니다.' }
            ]
          },
          {
            title: '셋째, \'[세계적 교육문화]\'로 세계와 연결하겠습니다',
            children: [
              { title: '교육은 교실 안에서만 완성되지 않습니다. [경쟁]을 넘어 [연대]와 [공존], [세계시민]교육과 [국제교류] 활동을 통해 [봉사]와 [나눔]으로 세계와 연결되도록 하겠습니다.' },
              { title: '학생은 배움 속에서 도전하고, 교사는 가르침의 즐거움 속에서 수업에 전념하며, 학부모는 신뢰로 학교와 협력하여 함께 성장할 것입니다.' }
            ]
          },
          {
            title: '결론',
            children: [
              { title: '우리는 지금, "[무엇을 지키고] / [무엇을 바꾸어야 하는가]?"라는 근본적인 질문 앞에 서 있습니다.' },
              { title: '아이들이 [주도적으로 배우고], 선생님의 [가르침이 존중받으며], 학교를 [신뢰의 배움터]로 지키겠습니다.' },
              { title: '\'[세계적 배움]·[세계적 가르침]·[세계적 교육문화]\'라는 세 축을 흔들림 없이 추진하여, 대한민국 교육을 바꾸겠습니다.' }
            ]
          }
        ]
      }
