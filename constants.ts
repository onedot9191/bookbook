            ...
            children: [
              {
                title: '대구 미래학교 운영 지원',
                children: [
                  { title: '긍정적 학교 문화 조성 및 지속적 실행력 강화' },
                  { title: '학교 핵심가치 및 역량 기반 교육과정 설계․운영' },
                  { title: '학생 역량 중심 탐구수업 설계 및 실천' }
                ]
              },
              {
                title: '운영 지원체제 구축',
                children: [
                  { title: '연차별 성장 지원 컨설팅 내실화' },
                  { title: '대구미래학교 평가(운영평가, 성과평가) 실시' }
                ]
              },
              {
                title: '교원역량 강화',
                children: [
                  { title: '대구미래학교 중심 지역학교 협력 네트워크 구축(초)' }
                ]
              }
            ]
          }
