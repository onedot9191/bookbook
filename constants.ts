...
export const INTERVIEW_SECTIONS: SectionData[] = [
  {
    ...
    content: [
      "1. 구상형",
      "",
      "서론: 제시된 <주제> [상황]은 [교육 현장]에서 마주할 수 있는 [현실적인 과제]입니다. [상황]을 [올바르게 해결]하기 위해 [교사]의 [신중하고 전문적인 대처]가 [필요한 시점]입니다.",
      "",
      "결론: 이번 일은 [당장의 문제 해결]을 넘어 [신뢰]를 회복하는 [디딤돌]이 될 것입니다. [비 온 뒤에 땅이 굳어지듯], [더욱 단단하고 성숙한] 교육 현장을 만들겠습니다.",
      "",
      "2. 즉답형",
      "",
      "서론: <주제>는 교사가 [외면하지 않고] 반드시 [해결해야 할] 중요한 [책무]입니다.",
      "",
      "결론: 이러한 위기를 [긍정적인 변화]의 [발판]으로 삼겠습니다. [모두가 안심할 수 있는] 든든한 [울타리]가 되겠습니다."
    ]
  },
  {
    id: 'value',
    ...
    content: [
      "1. 구상형",
      "",
      "서론: [변화하는 환경] 속에서 <주제>은/는 우리 교육이 [놓치지 말아야 할] 핵심 [과제]입니다. 이를 [현장]에 [맞게 적용]하여 학생의 [성장]을 [돕는] 깊은 [고민]이 [필요합니다.",
      "",
      "결론: [형식적인 운영]에 [그치지 않고], <주제>가 [교실] 속에 [내실 있게 안착]되도록 하겠습니다. [미래를 배우고 함께 성장하는] 대구교육에 [보탬]이 되겠습니다.",
      "",
      "2. 즉답형",
      "",
      "서론: <주제>는 우리 학생들의 [꿈과 역량]을 [키워주기 위한] 필수적인 [자양분]입니다.",
      "",
      "결론: <주제>를 통해 학생들의 [잠재력]을 [꽃피우는] 든든한 [조력자]가 되겠습니다."
    ]
  },
  {
    id: 'data',
    ...
    content: [
      "1. 구상형",
      "",
      "서론: 제시된 <주제> 자료는 [현재 우리 교실의 모습]을 보여주는 의미 있는 [메시지]를 담고 있습니다. [올바른 지도]를 위해서는 [현상]에 대한 [정확한 이해]가 [선행]되어야 합니다.",
      "",
      "결론: [깊이 있는 이해]가 [발전의 시작]입니다. [보여주기식]이 아닌, [교육 현장]에 [닿는] 실질적인 [개선]을 이끌어내겠습니다.",
      "",
      "2. 즉답형",
      "",
      "서론: <주제> 현상은 [단순한 결과]가 아닙니다. [교육의 본질]을 고민하게 하는 [중요한 화두]입니다.",
      "",
      "결론: [겉핥기식 처방]을 [지양]하겠습니다. [근본적인 해결책]을 [실천]하여 [배움이 있는] 교실을 만들겠습니다."
    ]
  }
];
