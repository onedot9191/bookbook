...
export const INTERVIEW_SECTIONS: SectionData[] = [
  {
    ...
    content: [
      ...
      "",
      "결론: 이번 일은 [당장의 문제 해결]을 넘어 [교육 현장]을 [실질적으로 개선]하는 [계기]가 될 것입니다. [비 온 뒤에 땅이 굳어지듯], [더욱 단단하고 성숙한] 교육 현장을 만들겠습니다.",
      "",
      "2. 즉답형",
      "",
      "서론: <주제>는 교사가 [외면하지 않고] 반드시 [해결해야 할] 중요한 [책무]입니다.",
      "",
      "결론: 이러한 [위기]를 [긍정적인 변화]의 [발판]으로 삼겠습니다."
    ]
  },
  {
    id: 'value',
    ...
    content: [
      "1. 구상형",
      "",
      "서론: [변화하는 환경] 속에서 <주제>는 우리 교육이 [놓치지 말아야 할] 핵심 [과제]입니다. 이를 [현장]에 [맞게 적용]하여 학생의 [성장]을 [돕는] 깊은 [고민]이 필요합니다.",
      "",
