        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { title: '상호문화이해 교육 <br>cf.[이중언어교실], [이중언어 말하기 대회]' },
        ...
        children: [
          {
            title: '[보건]·[건강증진]교육',
            children: [
              { title: '학교급별 [보건교육] 및 [유해약물 오·남용] 예방 교육' },
              { title: '[학교흡연예방사업] 추진 및 [학생금연상담센터] 위탁 운영' },
              { title: '[심폐소생술] 등 [응급처치] 교육 실시' },
              { title: '감염병 관리: [1830 손씻기] 실천' },
              { title: '[학생건강검사](건강조사, 건강검진)' },
              { title: '[학생건강증진센터] 및 [학생건강증진캠프] 운영' },
              { title: '[학생생명존중]교육 및 [마음건강 증진]교육 운영' },
              { title: '[마음건강 위기학생] 조기 발견 및 지원 강화 <br> cf.[학생정서·행동특성 검사]' }
            ]
          },
          {
            title: '[체육]교육',
